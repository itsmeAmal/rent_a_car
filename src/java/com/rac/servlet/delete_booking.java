 ...
 * @author personal
 */
@WebServlet(name = "delete_booking", urlPatterns = {"/delete_booking"})
public class delete_booking extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            new BookingDaoImpl().DeleteBooking(commonController.getIntOrZeroFromString(id));
            response.sendRedirect("ManageBookings.jsp");
            
        } catch (SQLException ex) {
            Logger.getLogger(delete_booking.class.getName()).log(Level.SEVERE, null, ex);
        }
